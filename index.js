...
TeamFortress2.prototype.resetStrangeScores = function(itemID) {
	this._send(Language.ResetStrangeScores, Schema.CMsgGCResetStrangeScores, {
		"item_id": itemID
	});
};
...
TeamFortress2.prototype.removeStrangePart = function(itemID, scoreType) {
	...
	this._send(Language.RemoveStrangePart, proto, message);
};
...
TeamFortress2.prototype.fulfillRecipe = function(itemID, components) {
	...
	this._send(Language.FulfillDynamicRecipeComponent, proto, message);
};
